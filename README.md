...
1. **Model as Service**: Through the prediction function
2. **Web UI**: Via Streamlit
3. **Batch Processing**: Through direct script execution
4. **Monitoring API**: For tracking model performance
